...
echo "Releasing ligo-memory: $LATEST → $VERSION"
...
gh release create "$VERSION" --repo linkeunid/ligo-memory --title "$VERSION" --notes "" --latest

echo "Released ligo-memory $VERSION"
